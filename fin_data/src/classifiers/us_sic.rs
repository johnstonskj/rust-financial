    ...
    let table: HashMap<u16, Code<u16>> = [
        ...
        (
            ...
            Code::<u16> {
                code: 2320,
                parent_code: None,
                description: "MEN'S & BOYS' FURNISHINGS, WORK CLOTHING, & ALLIED GARMENTS"
                    .to_string(),
            },
        ),
        (
        ...
        (
            ...
            Code::<u16> {
                code: 2780,
                parent_code: None,
                description: "BLANKBOOKS, LOOSELEAF BINDERS & BOOKBINDING & RELATED WORK"
                    .to_string(),
            },
        ),
        (
        ...
        (
            ...
            Code::<u16> {
                code: 3050,
                parent_code: None,
                description: "GASKETS, PACKING & SEALING DEVICES & RUBBER & PLASTICS HOSE"
                    .to_string(),
            },
        ),
        (
        ...
        (
            ...
            Code::<u16> {
                code: 3430,
                parent_code: None,
                description: "HEATING EQUIPMENT, EXCEPT ELECTRIC & WARM AIR; & PLUMBING FIXTURES"
                    .to_string(),
            },
        ),
        (
        ...
        (
            ...
            Code::<u16> {
                code: 3564,
                parent_code: None,
                description: "INDUSTRIAL & COMMERCIAL FANS & BLOWERS & AIR PURIFYING EQUIP"
                    .to_string(),
            },
        ),
        (
        ...
        (
            ...
            Code::<u16> {
                code: 3585,
                parent_code: None,
                description: "AIR-COND & WARM AIR HEATING EQUIP & COMM & INDL REFRIG EQUIP"
                    .to_string(),
            },
        ),
        (
        ...
        (
            ...
            Code::<u16> {
                code: 3812,
                parent_code: None,
                description: "SEARCH, DETECTION, NAVIGATION, GUIDANCE, AERONAUTICAL SYS"
                    .to_string(),
            },
        ),
        (
